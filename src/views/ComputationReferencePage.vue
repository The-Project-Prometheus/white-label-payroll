...
const data: Record<string, { id: number; name: string; formula: string; value: string; basis: string }[]> = {
  ...
  Allowances: [
    ...
    { id: 22, name: 'Employee Wellness Assistance', formula: '1 Mo. Basic (SG 19-1 or actual, higher)', value: '₱59,153+', basis: 'Senate Policy' },
    { id: 23, name: 'Senate Medical Assistance', formula: 'Fixed annual — February', value: '₱100,000', basis: 'Senate Policy' },
    { id: 24, name: 'Educational Assistance', formula: 'Fixed annual — March', value: '₱50,000', basis: 'Senate Policy' },
    { id: 25, name: 'Additional Grocery Expense', formula: 'Monthly (3 months service)', value: '₱20,000', basis: 'Senate Policy' },
    { id: 26, name: 'Reimbursable Transportation', formula: 'Monthly (3 consecutive months)', value: '₱20,000', basis: 'Senate Policy' },
  ],
  Timekeeping: [
    { id: 30, name: 'Work Schedule', formula: 'Compressed Work Week (Mon-Thu only)', value: '4 days', basis: 'Senate CWW' },
    { id: 31, name: 'Daily Requirement', formula: 'Hours per working day', value: '11 hrs', basis: 'Senate CWW' },
    { id: 32, name: 'Flexitime Window', formula: 'Arrival between 7:00 AM – 9:00 AM = NOT late', value: '7-9 AM', basis: 'Senate Policy' },
    { id: 33, name: 'Late Threshold', formula: 'After 9:00 AM', value: '9:00 AM', basis: 'Senate Policy' },
    { id: 34, name: 'Daily Rate Formula', formula: 'Monthly Salary ÷ working days in month', value: 'Salary÷Days', basis: 'Senate CWW' },
    { id: 35, name: 'Hourly Rate Formula', formula: 'Daily Rate ÷ 11', value: 'Daily÷11', basis: 'Senate CWW' },
    { id: 36, name: 'Overtime', formula: 'NO OT — extra hours are voluntary', value: 'None', basis: 'Senate CWW' },
